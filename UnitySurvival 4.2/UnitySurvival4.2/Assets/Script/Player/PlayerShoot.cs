...
public class PlayerShoot : MonoBehaviour
{
  ...
  //Er wordt gecheckt welke toets er wordt ingedrukt om te kijken wel wapen er gevuurt moet worden. Er wordt ook gecheckt of er genoeg kogels zitten in elk wapen.
  void Update()
  {
    WeaponCheck();                                                                                                                  
