...
public class Spider : MonoBehaviour
{
    ...
    //public Transform player; //Heeft de locatie van de player.
    ...
    protected bool isAlive = true; //Is true wanneer de spin leeft
    ...
    protected virtual void move() //De move methode
    {
        ...
        {
               //De distance wordt berekent tussen de player en de spin. Dit wordt opgeslagen in de variabele "distance".
            //Debug.Log(distance);

            if (distance <= maxDistance && distance >= maxDistanceAttack) 
            //Als de spin dichter bij is dan de afstand wanneer hij naar de player moet komen maar verder dan de afstand wanneer hij moet aanvallen.
            {
                walkToPlayer();
            }
